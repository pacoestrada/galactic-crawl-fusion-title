...
Esta guía prueba **v0.2.0 descargada de GitHub**, para distinguir fallos de distribución de fallos dentro del editor. El grafo y la animación proceden de la versión probada, pero el paquete se ha reconstruido para actualizar el texto inicial. No es un informe exhaustivo de resultados: las casillas permiten registrar cada comprobación concreta.

## 1. Descargar

- [ ] Abrir [la versión v0.2.0](https://github.com/pacoestrada/galactic-crawl-fusion-title/releases/tag/v0.2.0).
...
| --- | --- |
| El enlace no descarga o da 404 | Anota el enlace exacto y comprueba que estás en la etiqueta `v0.2.0`. |
