...
The title references **DejaVu Sans Bold** as its default typeface. No font file is included in the repository or the `.drfx` package. Reference previews use the locally installed font. Users may choose another installed font in the Inspector.
...
Design direction and publication: Paco Estrada. Fusion implementation, packaging, validation tooling and documentation developed with assistance from OpenAI Codex.
